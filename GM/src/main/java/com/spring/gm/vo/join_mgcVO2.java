...
public class join_mgcVO2 {
	...
	public String toString() {
		return "join_mgcVO2 [id=" + id + ", pwd=" + pwd + ", name=" + name + ", eng_name=" + eng_name + ", jumin1="
				...
				+ del + ", account_number=" + account_number + ", company=" + company + ", j_id=" + j_id + ", j_name="
				+ j_name + "]";
	}
