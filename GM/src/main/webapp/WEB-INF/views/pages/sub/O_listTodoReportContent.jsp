		        ...
		        <div class="paging">
					<c:if test="${cnt > 0}">
					    <c:if test="${startPage > pageBlock}">
					        ...
					        <a href="<c:url value='/pages/W_listTodoReportView?num=${num}&pageNum=${startPage - pageBlock}'/>">[◀]</a>
					    </c:if>
					    ...
					    <c:if test="${pageCount > endPage}">
					        <a href="<c:url value='/pages/W_listTodoReportView?num=${num}&pageNum=${startPage + pageBlock}'/>">[▶]</a>
					        <a href="<c:url value='/pages/W_listTodoReportView?num=${num}&pageNum=${pageCount}'/>">[▶▶]</a>
					    </c:if>
					</c:if>
	            </div>	
	        </form>
