...
<section>
	<article>
		...
		<form id="searchForm" method="post" action="/groupware/approval/work/apprlist/listApprReject.do?OWASP_CSRFTOKEN=T0I8-S60Q-SL26-7D62-JJNV-9V2H-ULMJ-5UZK" novalidate="novalidate">

			
				<input name="apprId" type="hidden" value="" title="hidden">
			
			
				<input name="listType" type="hidden" value="rejectList" title="hidden">
					...
					<table class="table table-striped striped02" id="listTable">
						...
						<tbody>							
							<tr style="background: rgb(249, 249, 249);">
								...
								<td style="background: rgb(249, 249, 249);"><div class="ellipsis"><span class="name"><a href="#a" onclick="spro.showUserContextMenu(this, 'U260298', 'bottom')">공선빈</a></span></div></td>
								<td style="background: rgb(249, 249, 249);">홈사랑넷</td>							
								<td style="background: rgb(249, 249, 249);">2019.01.16 18:20</td>					    
								<td style="background: rgb(249, 249, 249);">
									<div class="select2-container ap-status"><a class="btn reject" onclick="getViewApprLine(this, '26947161');"><span class="select2-category"><i class="icon reject"></i></span><span class="caret"></span></a></div>
								</td>																							
							</tr>
							<tr style="display:none;" id="apprLineTr26947161_U260222">
			    				<td colspan="8">
									<div id="26947161_U260222" style="display:none;">
									</div>					
								</td>
							</tr>	
						</tbody>
