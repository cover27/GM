		    ...
		    <form action="leaveapplication" method="post">
		        ...
		        <div class="salary_info" style="height: 320px;">
		            <table>
		                <tbody>
		                	<c:if test="${cnt == 0}">
			                    <tr>
			                        <td colspan="9" style="height:320px;">*데이터 정보가 없습니다.</td>
			                    </tr>
			                </c:if>
			                <c:if test="${cnt > 0}">
		        ...
		        <div>
		            ...
		            <table border="1">
		                ...
		                <tr>
		                    <td>휴가기간</td>
		                    <td colspan="3"><input type="date" id="begin" name="begin"> ~ <div id="end2"><input type="date" id="end" name="end" onchange="handler(event);"></div>
		                    </td>
		                    <td>일수</td>
		                    <td><input type="text" style="width:100px;" name="day" id="day" required></td>
		                    <td>휴가사유</td>
