	...
	<table>
		<tr>
			<th colspan="6" align="center" style="height:25px">
				...
				<a href="<c:url value='/admin/D_boardsUpdate?num=${num}&b_name=${b_name}&anon=${anon}&pageNum=${pageNum}'/>"> 게시판 수정 </a>
			</th>
		</tr>
				...
				<c:if test="${dto.del == 0}">
					<tr>
						...
						<td>
							...
							<a href="<c:url value='/pages/D_boardContent?boardnum=${dto.boardnum}&num=${num}&ref_level=${ref_level}&pageNum=${pageNum}&number=${number+1}'/>"> ${dto.subject} </a>
						</td>
