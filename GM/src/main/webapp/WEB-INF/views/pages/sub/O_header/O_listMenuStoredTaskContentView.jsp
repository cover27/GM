...
<div class="content-wrap">	<!-- 업무 보관함의 content 전체 view -->
		<div class="table-header">		<!-- 업무 보관함의 content 상위 view -->
			<div class="listinfo">
			...
			<div class="table-search" style="right:239px;">
	            <div class="input-unread">
	                <label>구분</label>
	                <select name="searchTaskStoredType" title="구분">
	                    <option value="">전체</option>
	                    <option value="ST1">등록</option>
	                    <option value="ST2">수신</option>
	                    <option value="ST3">참조</option>
	                </select>
	            </div>
