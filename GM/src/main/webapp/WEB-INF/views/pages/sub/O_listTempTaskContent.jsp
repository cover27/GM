...
<section>
	<article>
		...
		<div class="content-list">
	            <table class="table table-striped" id="tblList">
	                ...
	                <thead>
			            <tr>
			                ...
			                <th scope="col">번호</th>
			                <th scope="col">
			                    <a data-sortcolumn="TASKTYPE" href="#">업무형태<i class="fa fa-caret-up"><span class="blind">오름차순</span></i></a>
			                </th>
			                <th scope="col">
	                ...
	                <tbody>
	                    <tr class="important" style="background: rgb(249, 249, 249);">
	                              <td><input name="chkid" type="checkbox" title="checkbox" value="27216202"></td> 
	                        <td>1</td>
	                        <td>업무 요청</td>
	                        <td></td>
	                        <td class="text-left">
	                               <div class="ellipsis" title="l"><a href="javascript:void(0);" onclick="goURL('27216202')">l</a></div>
	                        </td>
	                        <td>요청 날짜</td>
	                        <td>등록 날짜</td>		       
	                    </tr>
	            ...
	            <div class="btn-wrap">
					<button type="button" class="btn btn-color7 br" onclick="deleteTempTask();">삭제</button>
	            </div>
        </div>
