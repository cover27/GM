			...
			<form method="post" action="P_SearchPaymentTool">
				...
				<div class="search-wrap">
					<div class="form-group">
						...
						<span>
							<label class="bold5px ml50">배정일<input type="date" title="시작일" name="searchStartDate" value="" placeholder="시작일" class="ml10"></label>
							<span>~</span>
							<input type="date" title="종료일" name="searchEndDate" value="" placeholder="종료일">
						</span>
